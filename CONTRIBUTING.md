...
- Provide project and platform versions (OS, browser version, etc), depending on what seems relevant.
...
Any improvement to the documentation is welcomed from an overhaul of the organization to a correct of the most subtle typo.
